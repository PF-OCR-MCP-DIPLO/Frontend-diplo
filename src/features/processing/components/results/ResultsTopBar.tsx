    ...
    <div className='flex flex-col gap-3 border-b border-border/60 px-4 py-3 md:flex-row md:items-center md:justify-between'>
      <div className='min-w-0'>
        <div className='flex flex-wrap items-center gap-2 text-sm text-muted-foreground'>
          <span className='max-w-[34ch] truncate font-medium text-foreground'>{fileName}</span>
          <span>·</span>
          ...
          <span>·</span>
          <button type='button' className='text-muted-foreground transition hover:text-foreground' onClick={() => onOpenPanel('issues')}>
      ...
      <div className='flex flex-wrap items-center gap-2'>
        <Button type='button' variant='ghost' size='sm' className='gap-2 text-muted-foreground' onClick={onRefresh} disabled={isRefreshing}>
