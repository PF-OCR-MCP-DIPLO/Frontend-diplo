  ...
  return (
    <div className='page-stack'>
      <PageHeader
        ...
        description='Empieza una carga nueva o retoma una ejecucion reciente.'
        actions={
          <>
        ...
        <Card className='surface-card-hero p-6 md:p-7'>
          <div className='space-y-5'>
            ...
            {latestRun ? (
              <button
                type='button'
                onClick={() => void openResult(latestRun.id, 'No se pudo cargar la ejecucion')}
              ...
              <div className='content-block-subtle p-4'>
                <p className='font-medium text-foreground'>Aun no hay ejecuciones</p>
        ...
        <div className='mb-4 flex items-center justify-between gap-3'>
          <div className='flex items-center gap-2'>
            ...
            <div>
              ...
              <p className='text-sm text-muted-foreground'>Abre una ejecucion para continuar donde la dejaste.</p>
            </div>
          </div>
